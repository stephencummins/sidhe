        ...
        <div className="relative max-w-4xl mx-auto bg-stone-900/70 backdrop-blur-sm border-2 border-amber-900/50 p-8">
          ...
          {isLoading ? (
            ...
            <div className="prose prose-invert max-w-none markdown-interpretation">
              <ReactMarkdown
                className="text-amber-200/90 leading-relaxed"
                components={{
                  h1: ({node, ...props}) => <h1 className="text-amber-100 font-bold text-3xl mb-4 mt-6" style={{ fontFamily: 'Georgia, serif' }} {...props} />,
                  h2: ({node, ...props}) => <h2 className="text-amber-200 font-bold text-2xl mb-3 mt-5" style={{ fontFamily: 'Georgia, serif' }} {...props} />,
                  h3: ({node, ...props}) => <h3 className="text-amber-300 font-semibold text-xl mb-2 mt-4" style={{ fontFamily: 'Georgia, serif' }} {...props} />,
                  p: ({node, ...props}) => <p className="text-amber-200/90 mb-4 leading-relaxed" style={{ fontFamily: 'Georgia, serif' }} {...props} />,
                  ul: ({node, ...props}) => <ul className="text-amber-200/90 mb-4 ml-6 list-disc" style={{ fontFamily: 'Georgia, serif' }} {...props} />,
                  ol: ({node, ...props}) => <ol className="text-amber-200/90 mb-4 ml-6 list-decimal" style={{ fontFamily: 'Georgia, serif' }} {...props} />,
                  li: ({node, ...props}) => <li className="mb-2" {...props} />,
                  strong: ({node, ...props}) => <strong className="text-amber-100 font-bold" {...props} />,
