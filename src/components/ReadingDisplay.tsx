  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-900 via-amber-950 to-stone-950 p-4 py-12">
      ...
      {selectedCardIndex !== null && (
        ...
        >
          <div
            className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-stone-950 border-2 border-amber-700/50 p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1">
                <div className="mb-6">
                  <p className="text-amber-500 font-semibold text-sm mb-2" style={{ fontFamily: 'Georgia, serif' }}>
                    {reading.cards[selectedCardIndex].position}
                  </p>
                  <h3 className="text-3xl font-bold text-amber-100 mb-2" style={{ fontFamily: 'Georgia, serif' }}>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {reading.cards[selectedCardIndex].card.keywords.map((keyword, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 bg-amber-900/40 border border-amber-700/40 text-amber-300 text-sm"
                        style={{ fontFamily: 'Georgia, serif' }}
                      >
                        {keyword}
                      </span>
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="text-amber-400 font-semibold mb-3 flex items-center gap-2" style={{ fontFamily: 'Georgia, serif' }}>
                      <RunicSymbol variant="ansuz" className="w-5 h-6 text-amber-600" />
                      Upright Meaning
                    </h4>
                    <p className="text-amber-200/90 leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
                  ...
                  <div>
                    <h4 className="text-amber-400 font-semibold mb-3 flex items-center gap-2" style={{ fontFamily: 'Georgia, serif' }}>
                      <RunicSymbol variant="kenaz" className="w-5 h-6 text-amber-600" />
                      Reversed Meaning
                    </h4>
                    <p className="text-amber-200/90 leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
