                ...
                <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                  <div className="bg-stone-900/50 border-2 border-amber-800/40 p-4 sm:p-6">
                    ...
                    <p className="text-amber-200/95 text-base sm:text-lg leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
                      {reading.cards[selectedCardIndex].card.upright_meaning || 'No upright meaning available'}
                    </p>
                  </div>
                  ...
                  <div className="bg-stone-900/50 border-2 border-amber-800/40 p-4 sm:p-6">
                    ...
                    <p className="text-amber-200/95 text-base sm:text-lg leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
                      {reading.cards[selectedCardIndex].card.reversed_meaning || 'No reversed meaning available'}
                    </p>
                    {!reading.cards[selectedCardIndex].card.reversed_meaning && (
                      <pre className="text-xs text-amber-500 mt-2">
                        {JSON.stringify(reading.cards[selectedCardIndex].card, null, 2)}
                      </pre>
                    )}
                  </div>
                </div>
