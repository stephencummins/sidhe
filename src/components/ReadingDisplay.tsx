  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-900 via-amber-950 to-stone-950 p-4 py-12">
      ...
      {selectedCardIndex !== null && (
        ...
        >
          <div
            className="relative bg-gradient-to-br from-stone-900 via-amber-950 to-stone-950 border-4 border-amber-700/60 shadow-2xl shadow-amber-900/40 p-12 max-w-6xl w-full max-h-[95vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="absolute top-6 left-6 w-12 h-12 border-t-4 border-l-4 border-amber-600/50"></div>
            <div className="absolute top-6 right-6 w-12 h-12 border-t-4 border-r-4 border-amber-600/50"></div>
            <div className="absolute bottom-6 left-6 w-12 h-12 border-b-4 border-l-4 border-amber-600/50"></div>
            <div className="absolute bottom-6 right-6 w-12 h-12 border-b-4 border-r-4 border-amber-600/50"></div>

            <button
              onClick={() => setSelectedCardIndex(null)}
              className="absolute top-6 right-6 z-10 text-amber-400 hover:text-amber-200 transition-colors bg-stone-900/50 rounded-full p-2"
            >
              <X className="w-8 h-8" />
            </button>
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center lg:items-start">
              ...
              <div className="flex-1 max-w-2xl">
                <div className="mb-8">
                  <p className="text-amber-500 font-semibold text-base mb-3 uppercase tracking-wide" style={{ fontFamily: 'Georgia, serif' }}>
                    {reading.cards[selectedCardIndex].position}
                  </p>
                  <h3 className="text-5xl font-bold text-amber-100 mb-6" style={{ fontFamily: 'Georgia, serif' }}>
                  ...
                  <div className="flex flex-wrap gap-3 mb-6">
                    {reading.cards[selectedCardIndex].card.keywords.map((keyword, idx) => (
                      <span
                        key={idx}
                        className="px-4 py-2 bg-amber-900/50 border-2 border-amber-700/50 text-amber-200 text-base font-medium"
                        style={{ fontFamily: 'Georgia, serif' }}
                      >
                        {keyword}
                      </span>
                ...
                <div className="space-y-8">
                  <div className="bg-stone-900/50 border-2 border-amber-800/40 p-6">
                    <h4 className="text-amber-300 font-bold text-xl mb-4 flex items-center gap-3" style={{ fontFamily: 'Georgia, serif' }}>
                      <RunicSymbol variant="ansuz" className="w-8 h-10 text-amber-600" />
                      Upright Meaning
                    </h4>
                    <p className="text-amber-200/95 text-lg leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
                  ...
                  <div className="bg-stone-900/50 border-2 border-amber-800/40 p-6">
                    <h4 className="text-amber-300 font-bold text-xl mb-4 flex items-center gap-3" style={{ fontFamily: 'Georgia, serif' }}>
                      <RunicSymbol variant="kenaz" className="w-8 h-10 text-amber-600" />
                      Reversed Meaning
                    </h4>
                    <p className="text-amber-200/95 text-lg leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
