          ...
          {reading.cards.map((sc, index) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                {sc.isReversed && (
                  <p className="text-purple-400 text-xs font-semibold mt-1 italic" style={{ fontFamily: 'Georgia, serif' }}>
                    ⟲ Reversed
                  </p>
                )}
                ...
                <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                  <div className="bg-stone-900/50 border-2 border-amber-800/40 p-4 sm:p-6">
                    <h4 className="text-amber-300 font-bold text-lg sm:text-xl mb-3 sm:mb-4 flex items-center gap-2 sm:gap-3" style={{ fontFamily: 'Georgia, serif' }}>
                      ...
                      {reading.cards[selectedCardIndex].isReversed ? 'Current Orientation: Reversed' : 'Current Orientation: Upright'}
                    </h4>
                    ...
                    <div className="mt-4 pt-4 border-t border-amber-700/30">
                      ...
                      <p className="text-amber-200/80 text-sm leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
                        {reading.cards[selectedCardIndex].isReversed
                          ? `When reversed, this card suggests blocked energy or the shadow aspects of its upright meaning. Consider what obstacles or internal resistance might be present. Reversed cards often indicate delays, internalization, or the need to address underlying issues before moving forward.`
                  ...
                  <div className="bg-stone-900/50 border-2 border-amber-800/40 p-4 sm:p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="pt-3 border-t border-amber-700/20">
                        <p className="text-amber-400 text-sm font-semibold mb-2" style={{ fontFamily: 'Georgia, serif' }}>Reversed:</p>
                        <p className="text-amber-200/90 text-sm sm:text-base leading-relaxed" style={{ fontFamily: 'Georgia, serif' }}>
                          {meaningType === 'celtic' && reading.cards[selectedCardIndex].card.celtic_reversed
                            ? reading.cards[selectedCardIndex].card.celtic_reversed
                            : reading.cards[selectedCardIndex].card.reversed_meaning}
