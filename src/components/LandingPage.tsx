      ...
      <div className="max-w-4xl mx-auto px-4 py-16 relative z-10">
        ...
        <div className="mt-16 flex flex-col items-center gap-6">
          <button
            ...
            className="group relative px-12 py-4 text-lg font-bold transition-all duration-500 transform hover:scale-105 overflow-hidden bg-gradient-to-br from-amber-700 via-amber-800 to-amber-900 border-2 border-amber-600 shadow-xl hover:shadow-2xl flex items-center justify-center gap-3"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-amber-500/30 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000" />
            <svg className="w-5 h-5 relative z-10 drop-shadow-lg" viewBox="0 0 24 24">
              <path
                fill="#f5e6d3"
            ...
            <span className="relative z-10 tracking-wide drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]" style={{ fontFamily: 'Cinzel, serif', color: '#f5e6d3' }}>
              Sign in with Google
            </span>
